      ...
      <div className="section-padding grid md:grid-cols-2 lg:grid-cols-4 gap-12 text-slate-600">
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <a
              href="https://www.instagram.com/sumpcleaning__?igsh=MXFpYXBla2VoZnF2MA%3D%3D&utm_source=qr"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center text-[#E4405F] hover:bg-[#E4405F] hover:text-white transition-all duration-300"
            >
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            ...
            <li className="flex gap-3">
              <span className="text-blue-600 font-bold">📞</span>
              <span className="font-bold text-slate-900">+91 81234 32009</span>
            </li>
            <li className="flex gap-3">
              <span className="text-blue-600 font-bold">✉️</span>
              <a href="mailto:servicerkcleaning@gmail.com" className="font-medium hover:text-blue-600 transition-colors">servicerkcleaning@gmail.com</a>
            </li>
          </ul>
        </div>
